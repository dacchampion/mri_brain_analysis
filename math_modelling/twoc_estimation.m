...
for case_number=1:num_cases
    ...
    startx_mat = [sqrt(S0_vec), asin(sqrt(T2_vec/1000)), asin(sqrt(T2_vec/1000)), ones(size(S0_vec, 1), 1)*0.5];
    ...
    for vox_ind=1:num_vox
        ...
        all_parameter_hat(vox_ind, 2) = 1000*sin(parameter_hat(2))^2;
        all_parameter_hat(vox_ind, 3) = 10*sin(parameter_hat(2))^2;
